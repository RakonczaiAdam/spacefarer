...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "spacefarerlist/test/integration/FirstJourney",
    "spacefarerlist/test/integration/SpacefarerListJourney",
    "spacefarerlist/test/integration/SpacefarerObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
